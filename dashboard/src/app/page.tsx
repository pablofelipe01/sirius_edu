  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard icon="✅" value={submissionsRes.data?.length || 0} label="Entregas totales" color="purple" />
      </div>

      <div className="bg-white rounded-xl border border-gray-100 p-5">
        <h2 className="font-semibold text-gray-800 mb-4">Bienvenido al Panel del Profesor</h2>
        <p className="text-gray-500 text-sm">
          Desde aqui puedes crear lecciones estructuradas con capitulos, misiones y tests, revisar
          las entregas de tus alumnos y responder sus preguntas. Las lecciones llegan a los alumnos
          a traves de la red mesh LoRa, sin necesidad de internet.
        </p>
      </div>
    </div>
  )
